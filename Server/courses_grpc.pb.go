...
type CoursesClient interface {
	// Sends a greeting
	SayHello(ctx context.Context, in *CourseRequest, opts ...grpc.CallOption) (*CoursesReply, error)
}
...
func (c *coursesClient) SayHello(ctx context.Context, in *CourseRequest, opts ...grpc.CallOption) (*CoursesReply, error) {
	out := new(CoursesReply)
	err := c.cc.Invoke(ctx, "/main.Courses/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoursesServer interface {
	// Sends a greeting
	SayHello(context.Context, *CourseRequest) (*CoursesReply, error)
...
func (UnimplementedCoursesServer) SayHello(context.Context, *CourseRequest) (*CoursesReply, error) {
...
func _Courses_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CourseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoursesServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.Courses/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoursesServer).SayHello(ctx, req.(*CourseRequest))
	}
...
var Courses_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHello",
			Handler:    _Courses_SayHello_Handler,
		},
	},
